...
class PenjualanAxiosController extends Controller
{
    public function index()
    {
        $penjualan = Penjualan::all();
        return view('ajax_axios.penjualanAxios', compact('penjualan'))->with('title', 'Penjualan (Axios)');
    }

    public function create()
    {
        return view('ajax_axios.penjualanCreateAxios');
    }
